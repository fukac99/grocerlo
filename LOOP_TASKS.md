...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| T008 | Done | implementation-subagent | 2026-06-28 20:29 UTC+2 | task/T008-billa-retailer-product-normalization | https://github.com/fukac99/grocerlo/pull/16 | open | 2026-06-28 20:36 UTC+2 | pending |  | Normalize stored BILLA raw products into retailer products | `backend/app/normalization`, `backend/app/db`, `backend/app/models`, focused tests | T003,T005 | Implemented idempotent scrape-run normalization from `raw_products` to `retailer_products`, preserving raw rows/source references and handling price/package/promotion fields. |
