...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| T010 | Ready |  |  | task/T010-billa-product-search-api |  | none |  | none |  | Add BILLA-only product search API | `backend/app/api`, `backend/app/db`, `backend/app/main.py`, API tests | T008 | Ready after T008 merged; acceptance: `GET /products/search?q=...` returns normalized BILLA products with price/unit/category/source fields. |
...
| T027 | Done | coordinator | 2026-06-28 21:08 UTC+2 | task/T027-post-pr20-ledger-sync |  | none |  | pending |  | Sync ledger after frontend and data workflow merges | `LOOP_TASKS.md`, `LOOP_LOG.md`, `LOOP_STATE.md` | T026 | Coordinator ledger sync; PR and review pending. |
