...
| T041 | Done | coordinator | 2026-06-28 22:00 UTC+2 | task/T041-prioritize-real-data-ingest |  | none |  | not_required |  | Prioritize real BILLA ingest execution task | `LOOP_TASKS.md`, `LOOP_STATE.md` |  | Markdown-only coordinator PR to make T040 the highest-priority real-data task. |
