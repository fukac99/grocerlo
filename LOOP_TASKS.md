...
| T009 | Done | implementation-subagent | 2026-06-28 20:45 UTC+2 | task/T009-stored-data-sanity-report | https://github.com/fukac99/grocerlo/pull/18 | open | 2026-06-28 20:51 UTC+2 | pending |  | Add low-volume stored-data sanity report | `scripts`, read-only DB query helpers, docs/README if needed | T003,T005 | Added stored scrape-run sanity report CLI with aggregate counts, raw product quality issues, and bad-row identifiers. |
