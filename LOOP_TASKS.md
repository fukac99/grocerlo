...
| T003 | Done | postgres-store-subagent | 2026-06-28 19:59 UTC+2 | task/T003-postgres-store-path | https://github.com/fukac99/grocerlo/pull/11 | open | 2026-06-28 20:12 UTC+2 | pending | review-subagent | Start Postgres, run migrations, and test `--store` path | `docker-compose.yml`, `backend/alembic`, database | T001,T002,T006 | PR opened. Docker daemon was unavailable, so Postgres/store validation is blocked; dry BILLA scrape passed for 1 category and 3 products. |
