...
| T020 | Done | coordinator | 2026-06-28 20:30 UTC+2 | task/T020-scope-ingest-and-app-work |  | none |  | pending |  | Scope full ingest and visual app work | `LOOP_TASKS.md`, `LOOP_STATE.md`, `LOOP_LOG.md` | T019 | Coordinator scoping task requested by user; PR and review pending. |
