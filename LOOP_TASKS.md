...
| T013 | Done | implementation-subagent | 2026-06-28 20:29 UTC+2 | task/T013-mpreis-low-volume-discovery | https://github.com/fukac99/grocerlo/pull/15 | open | 2026-06-28 20:36 UTC+2 | pending | review-subagent | Add MPREIS low-volume discovery dry run | `backend/app/scrapers/mpreis.py`, `scripts/scrape_once.py`, `docs/scraper-notes/mpreis.md`, tests/fixtures if applicable | T003,T005,T012 | PR open for review; dry-run only, 1 category-equivalent page and 3 products. |
