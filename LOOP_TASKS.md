...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| T002 | In Progress | subagent | 2026-06-28 19:18 UTC+2 | task/T002-billa-dry-scrape-validation |  | none |  | none |  | Run BILLA dry scrape and inspect sample output | `scripts/scrape_once.py`, `backend/app/scrapers/billa.py`, `docs/scraper-notes/billa.md` | T001,T006 | Dry scrape succeeded with 1 category and 3 products; sample looks plausible. |
