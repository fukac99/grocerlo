...
| T036 | Done | coordinator | 2026-06-28 21:24 UTC+2 | task/T036-post-agent-ledger-sync |  | none |  | not_required |  | Sync ledger after T010/T021 and UI scoping merges | `LOOP_TASKS.md`, `LOOP_LOG.md`, `LOOP_STATE.md` |  | Markdown-only coordinator PR; archives merged rows and refreshes next ready tasks. |
