...
| T015 | Done | implementation-subagent | 2026-06-28 21:26 UTC+2 | task/T015-billa-mpreis-rule-matching | https://github.com/fukac99/grocerlo/pull/30 | open | 2026-06-28 21:30 UTC+2 | passed | implementation-subagent | Add BILLA/MPREIS rule-based product matching | `backend/app/matching`, `backend/app/models`, focused tests | T008,T013 | PR opened; review clean for architecture/security/bugs/data-quality. Real cross-retailer E2E still needs stored/normalized MPREIS rows from T028. |
...
| T022 | Done | coordinator | 2026-06-28 21:26 UTC+2 | task/T022-retailer-ingest-runbook | https://github.com/fukac99/grocerlo/pull/29 | open | 2026-06-28 21:30 UTC+2 | not_required |  | Document full-ingest readiness runbook for available retailers | `docs`, `README.md` if needed | T013,T021 | Markdown-only coordinator PR; documents current retailer ingest readiness, approvals, limits, stop conditions, commands, cleanup, sanity reports, and MPREIS dry-run-only status. |
...
| T032 | Done | implementation-subagent | 2026-06-28 21:26 UTC+2 | task/T032-highlight-cheapest-ui | https://github.com/fukac99/grocerlo/pull/28 | open | 2026-06-28 21:27 UTC+2 | passed | implementation-subagent | Highlight cheapest supermarket offer in comparison rows | `frontend/components/comparison-table.tsx`, `frontend/app/globals.css`, focused frontend checks | T026 | Implemented light-green cheapest-offer highlighting for each product/package row; ties highlight all matching retailer cells; missing offers remain unhighlighted. Local review passed for behavior, accessibility, and UX. |
...
| T036 | Done | coordinator | 2026-06-28 21:24 UTC+2 | task/T036-post-agent-ledger-sync | https://github.com/fukac99/grocerlo/pull/27 | open | 2026-06-28 21:27 UTC+2 | not_required |  | Sync ledger after T010/T021 and UI scoping merges | `LOOP_TASKS.md`, `LOOP_LOG.md`, `LOOP_STATE.md` |  | Markdown-only coordinator PR; archives merged rows and refreshes next ready tasks. |
