...
| T026 | Done | coordinator | 2026-06-28 21:03 UTC+2 | task/T026-supermarket-column-layout |  | none |  | pending |  | Align frontend table with per-supermarket comparison layout | `frontend`, `LOOP_TASKS.md`, `LOOP_STATE.md` | T023 | Follow-up from user feedback; PR and review pending. |
