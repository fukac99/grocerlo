...
| T017 | Done | coordinator | 2026-06-28 19:55 UTC+2 | task/T017-refresh-merged-pr-statuses |  | none |  | pending |  | Refresh merged PR statuses and scope next tasks | `LOOP_TASKS.md`, `LOOP_STATE.md`, `LOOP_LOG.md` |  | Coordinator ledger update for this tick; PR and review pending. |
