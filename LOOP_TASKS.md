...
| T003 | In Progress | postgres-store-subagent | 2026-06-28 19:59 UTC+2 | task/T003-postgres-store-path |  | none |  | none |  | Start Postgres, run migrations, and test `--store` path | `docker-compose.yml`, `backend/alembic`, database | T001,T002,T006 | T002 has merged; validating the stored scrape path. |
