...
| T026 | Done | coordinator | 2026-06-28 21:03 UTC+2 | task/T026-supermarket-column-layout | https://github.com/fukac99/grocerlo/pull/20 | open | 2026-06-28 21:05 UTC+2 | passed | review-subagent | Align frontend table with per-supermarket comparison layout | `frontend`, `LOOP_TASKS.md`, `LOOP_STATE.md` | T023 | Review passed. Rows now group by product/package with one supermarket column containing price, source link, and promotion. |
