...
| T022 | In Progress | coordinator | 2026-06-28 21:26 UTC+2 | task/T022-retailer-ingest-runbook |  | none |  | none |  | Document full-ingest readiness runbook for available retailers | `docs`, `README.md` if needed | T013,T021 | Ready after T021 merged; acceptance: checklist for which retailers can be ingested, required approvals, rate limits, stop conditions, commands, and rollback/cleanup steps. |
