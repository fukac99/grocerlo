...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| T002 | Done | billa-validation-subagent | 2026-06-28 19:17 UTC+2 | task/T002-billa-dry-scrape-validation | https://github.com/fukac99/grocerlo/pull/6 | open | 2026-06-28 19:33 UTC+2 | in_progress | review-subagent | Run BILLA dry scrape and inspect sample output | `scripts/scrape_once.py`, `backend/app/scrapers/billa.py` | T001,T006 | PR opened. Low-volume scrape returned plausible category/product data; review in progress before merge. |
