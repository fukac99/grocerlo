...
| T030 | In Progress | implementation-subagent | 2026-06-28 21:36 UTC+2 | task/T030-reconcile-once-cli |  | none |  | pending |  | Add one-off reconciliation CLI | `scripts/reconcile_once.py`, `backend/app/matching` | T015 | Ready after T015 merged; acceptance: run matching over normalized retailer products and report candidate match counts/confidence buckets. |
