...
| T018 | Done | coordinator | 2026-06-28 20:14 UTC+2 | task/T018-correct-loop-ledger-after-merges |  | none |  | pending |  | Correct loop ledger after merged and blocked PRs | `LOOP_TASKS.md`, `LOOP_STATE.md` | T017 | Coordinator ledger correction for stale main state; PR and review pending. |
