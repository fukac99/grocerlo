...
| T023 | In Progress | implementation-subagent | 2026-06-28 20:45 UTC+2 | task/T023-frontend-visual-inspection-shell |  | none |  | none |  | Scaffold frontend visual inspection shell | `frontend`, root docs if needed | T006 | Ready and independent of backend API; acceptance: Next.js app shell with searchable/filterable comparison table using static sample data, clear mock-data banner, and local run instructions. |
